    ...
    function printSolution($theHeader = NULL)
    {
        ...
        for ($i = 1; $i <= 9; $i++)
        {
        	if ($theLast == 2)
        	{
        		...
        		// printf("<tr class='blah45'>\n") ;

        	}

            // printf("<td class='blah'><table border=\"1\" width=\"100%%\">\n") ;
        	...
        	for ($j = 1; $j <=9; $j++)
        	{
                ...
                // printf("<td class='blah2' style=\"text-align: center; padding: .6em; color: %s; font-weight: %s; font-size: %s;\">",
        ...
        $new_table1 = array_merge($table[0], $table[3], $table[6]);
        $new_table2 = array_merge($table[1], $table[4], $table[7]);
        $new_table3 = array_merge($table[2], $table[5], $table[8]);
        $new_table4 = array_merge($table[9], $table[12], $table[15]);
        $new_table5 = array_merge($table[10], $table[13], $table[16]);
        $new_table6 = array_merge($table[11], $table[14], $table[17]);
        $new_table7 = array_merge($table[18], $table[21], $table[24]);
        $new_table8 = array_merge($table[19], $table[22], $table[25]);
        $new_table9 = array_merge($table[20], $table[23], $table[26]);

        
       $numbers = array_merge($new_table1,$new_table2,$new_table3,$new_table4,$new_table5,$new_table6,$new_table7,$new_table8,$new_table9);
        //  echo "<pre>";
        // var_dump($numbers);
        // echo "</pre>";
       return $numbers;
